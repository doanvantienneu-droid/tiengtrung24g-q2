// Kho dữ liệu lớp học qua Upstash Redis (REST, không cần thư viện).
// Biến môi trường: UPSTASH_REDIS_REST_URL, UPSTASH_REDIS_REST_TOKEN, TEACHER_PASS
...
function dayStr(){
  const d = new Date(Date.now() + 7*3600*1000); // giờ Việt Nam (UTC+7)
